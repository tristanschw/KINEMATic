...
def main(robo):
    ...
    while not rospy.is_shutdown():
        ...
        request.ik_request.pose_stamped.pose.position.x = 0.790
        request.ik_request.pose_stamped.pose.position.y = 0.093
        request.ik_request.pose_stamped.pose.position.z = 0.026 
        try:
            # Send the request to the service
            response = compute_ik(request)
        ...
        request.ik_request.pose_stamped.pose.position.x = 0.805
        request.ik_request.pose_stamped.pose.position.y = 0.120
        request.ik_request.pose_stamped.pose.position.z = -0.123 
        try:
            # Send the request to the service
            response = compute_ik(request)
